...
generated building, and every building inside a facility, has floor plans
...
pnpm sweep        # headless matrix over presets, eras, cultures and edge cases (--quick for a subset, --range a-b for a chunk)
```
