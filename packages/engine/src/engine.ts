    ...
    async setDocument(doc, options) {
      ...
      const stats: EngineStats = {
        ...
        rail: {
          ...
          tramTrackKm: trams.reduce((a, t) => a + t.stats.trackKm, 0),
          tramSharedKm: trams.reduce((a, t) => a + t.stats.sharedKm, 0),
          tramLines: trams.reduce((a, t) => a + t.stats.lines, 0),
          crossovers: rail.stats.crossovers,
          flyovers: rail.stats.flyovers,
          sidings: facilities.spurs.features.filter((s) => s.properties.class === 'siding').length,
